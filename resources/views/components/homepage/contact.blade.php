        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="md:col-span-1">
            ...
            <input type="text" id="full_name" name="full_name" value="{{ old('full_name') }}" required
              ...
              placeholder="John Doe">
            <p class="mt-1 text-sm text-red-600 error-message" id="error-full_name"></p>
          </div>
          ...
          <div>
            ...
            <input type="number" id="age" name="age" value="{{ old('age') }}" required min="1" max="120"
              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition"
              placeholder="30">
            <p class="mt-1 text-sm text-red-600 error-message" id="error-age"></p>
          </div>
          ...
          <div>
            ...
            <p class="mt-1 text-sm text-red-600 error-message" id="error-disability_type"></p>
          </div>
          ...
          <div>
            ...
            <input type="tel" id="contact_number" name="contact_number" value="{{ old('contact_number') }}" required
              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition"
              placeholder="9876543210">
            <p class="mt-1 text-sm text-red-600 error-message" id="error-contact_number"></p>
          </div>
          ...
          <div class="md:col-span-2">
            ...
            <textarea id="information_request" name="information_request" required rows="4"
              ...
              placeholder="Please describe the information you're seeking or any questions you have...">{{ old('information_request') }}</textarea>
            <p class="mt-1 text-sm text-red-600 error-message" id="error-information_request"></p>
          </div>
        </div>
